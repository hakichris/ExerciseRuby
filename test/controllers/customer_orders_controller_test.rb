...
class CustomerOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create customer_order" do
    assert_difference("CustomerOrder.count") do
      post customer_orders_url, params: { customer_order: { address: @customer_order.address, amount_ordered: @customer_order.amount_ordered, name: @customer_order.name, phoneNumber: @customer_order.phoneNumber } }
    end
  ...
  test "should update customer_order" do
    patch customer_order_url(@customer_order), params: { customer_order: { address: @customer_order.address, amount_ordered: @customer_order.amount_ordered, name: @customer_order.name, phoneNumber: @customer_order.phoneNumber } }
